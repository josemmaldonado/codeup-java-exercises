...
//    private String name;
//
//    public JavaFundamentals(int age, boolean isRescue, String name) {
//        this.age = age;
...
//
////    overloading the Paths.get combining the directorys path and the filename.
//
...
////        writing a file
////        we created a list
//        List<String>groceryList = Arrays.asList("food","veggies","milk","meats","chicken");
//
//
////        adding to the list
//
//        Files.write(dataFile, Arrays.asList("egg"), StandardOpenOption.APPEND);
//
